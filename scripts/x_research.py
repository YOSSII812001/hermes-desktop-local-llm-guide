...
from tools.x_search_tool import check_x_search_requirements  # noqa: E402
from tools.x_research_tool import x_research_tool  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Run bounded Hermes X research directly.")
    parser.add_argument("goal", help="Research goal or topic for X.")
    parser.add_argument("--query", action="append", default=[], help="Explicit X query. Repeatable.")
    parser.add_argument("--max-queries", type=int, default=4, help="Maximum x_search calls. Clamped to 1-8.")
    ...
    raw = x_research_tool(
        goal=args.goal,
        search_queries=args.query or None,
